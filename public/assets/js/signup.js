$(document).ready(function() {
  ...
  phoneInput.bind('input propertychange',function(){
    ...
    {
      $("#phone-form").removeClass("has-success");

      $("#phone-form").addClass("has-error");
      $("#phone-feedback").text("Invalid Phone");
      $("#phone-additional-feedback").text("Ex:609-123-4567 or (609)123-4567");
    
    } else {
      $("#phone-form").removeClass("has-error");

      $("#phone-form").addClass("has-success");
      $("#phone-feedback").text("Valid Phone!");
      $("#phone-additional-feedback").text("");
    }
  });
